            ...
            <div className="table-search">
                ...
                <div className="relative">
                    ...
                    <input
                        type="text"
                        id="table-search"
                        className="block h-8 ps-10 text-xs text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700"
                        placeholder="Search"
                    />
                </div>
            </div>
